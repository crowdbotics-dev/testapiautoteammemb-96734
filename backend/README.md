...
## Project Structure
    ...
    ├── testapiautoteammemb_96734  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_96734`
...
2. Clone this repo and `cd testapiautoteammemb_96734`
